        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-screen items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-4xl mx-auto border border-gray-200/50 dark:border-gray-700/50"
            >
              {/* Header */}
              <div className="flex items-center justify-between p-6 border-b border-gray-200/50 dark:border-gray-700/50">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-1">
                    {feature} requires a Pro or Business plan
                  </p>
                </div>
                <button
                  onClick={onClose}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {plans.map((plan) => (
                    <motion.div
                      ...
                      className={`relative bg-white/80 dark:bg-gray-700/80 backdrop-blur-xl p-6 rounded-2xl shadow-xl border-2 ${
                        plan.popular 
                    ...
                    >
                      ...
                      <button
                        onClick={() => handleUpgrade(plan.name.toLowerCase() as PlanType)}
