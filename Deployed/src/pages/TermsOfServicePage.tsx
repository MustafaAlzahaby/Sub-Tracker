      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <section>
            ...
            <div className="prose dark:prose-invert max-w-none">
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                We want you to be fully satisfied with your SubTracker subscription. Our refund policy is designed to ensure that your experience with us is seamless. Please read the following terms carefully:
              </p>
              <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
                <li><strong>Eligibility for Refund:</strong> Refunds are available only within 30 days of purchase for annual subscriptions. Monthly subscriptions are non-refundable, but you may cancel at any time.</li>
                <li><strong>Partial Month Refunds:</strong> Refunds for partial months are not provided under any circumstances.</li>
                <li><strong>Non-Refundable Services:</strong> Any digital products, services already consumed, or subscription renewals after the 30-day period are not eligible for refunds.</li>
                <li><strong>Refund Requests:</strong> To request a refund, please contact our support team at <a href="mailto:support@example.com" className="text-blue-500">subtrackerai@gmail.com</a>. Provide your order details, including the purchase date, subscription plan, and reason for your refund request.</li>
                <li><strong>Refund Processing:</strong> Refunds are processed by Paddle. If you're eligible for a refund, it will be credited to the original payment method. Refunds may take up to 10 business days to appear on your statement.</li>
                <li><strong>Paddle's Role:</strong> Paddle handles all financial transactions for SubTracker. As a reseller, Paddle's terms and policies regarding payments, billing, and refunds apply to all transactions.</li>
              </ul>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                Please note that if you experience any issues with our service or need assistance with your refund request, don't hesitate to reach out to us. We are committed to providing the best experience for our users.
              </p>
            </div>
          </section>
